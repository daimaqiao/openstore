...
<hr />
<form action="/openstore/api/putavastar.php" method="post"
...
<p><b>resolution</b>: <input type="text" name="resolution" id="resolution" value="0x0" />(?x?)<p>

...
$length= array_key_exists("length", $_POST)? $_POST["length"]: "";
oim_reset($oim, $oim_size, array("length"=> $length));
...
// 输出结果
$dlurl= result_make_dlurl(get_baseurl(), "putvoice", $fileid_base64, $oim_base64);
